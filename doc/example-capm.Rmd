...
This is a simplified example of CAPM model from Petris (2011) using data from Berndt (1991).
...
[^alpha]: In the model estimated here, the intercepts for each stock, $\alpha_{j}$ are assumed to be zero.
...
Note: there tend to be a lot of divergences in this
