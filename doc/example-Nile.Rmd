...
The function 
```r
model_code <- stanc_builder(ssm_stan_model_path("local_level_stan"),
                            isystem = ssm_stan_include_path())
mod <- ssm_model(model_code = model_code[["model_code"]], ...)
```
