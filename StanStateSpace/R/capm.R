#' Monthly Returns on Stocks and Risk Free Asset for a CAPM model
#'
#' The data consist of monthly returns on four stocks (Mobil, IBM, Weyer, and Citicorp) from January 1978 to December 1987.
#' It also includes the interest rate on a 30-day Treasury Bill as a proxy for the risk-free asset, and
