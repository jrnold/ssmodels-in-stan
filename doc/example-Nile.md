...
#>  Elapsed Time: 6.57266 seconds (Warm-up)
#>                6.30181 seconds (Sampling)
#>                12.8745 seconds (Total)
```
...
#> Chain 1, Iteration: 450 / 500 [ 90%]  (Sampling)
#> Chain 1, Iteration: 500 / 500 [100%]  (Sampling)
#>  Elapsed Time: 28.5885 seconds (Warm-up)
#>                4.86822 seconds (Sampling)
#>                33.4567 seconds (Total)
...
#> Chain 1, Iteration: 450 / 500 [ 90%]  (Sampling)
#> Chain 1, Iteration: 500 / 500 [100%]  (Sampling)
#>  Elapsed Time: 5.54337 seconds (Warm-up)
#>                4.36378 seconds (Sampling)
#>                9.90715 seconds (Total)
#> The following numerical problems occured the indicated number of times after warmup on chain 1
#>                                                                                                      count
...
#> Chain 1, Iteration: 450 / 500 [ 90%]  (Sampling)
#> Chain 1, Iteration: 500 / 500 [100%]  (Sampling)
#>  Elapsed Time: 31.9868 seconds (Warm-up)
#>                12.1989 seconds (Sampling)
#>                44.1857 seconds (Total)
#> The following numerical problems occured the indicated number of times after warmup on chain 1
#>                                                                                                      count
